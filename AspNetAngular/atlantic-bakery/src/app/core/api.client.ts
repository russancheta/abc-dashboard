...
export class RegistrationViewModel implements IRegistrationViewModel {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.middleName = _data["middleName"];
            this.pm = _data["pm"];
            this.pmRemarks = _data["pmRemarks"];
            this.pmPick = _data["pmPick"];
            this.itrm = _data["itrm"];
            this.itrmRemarks = _data["itrmRemarks"];
            this.itrmPick = _data["itrmPick"];
...
export class AccountViewModel implements IAccountViewModel {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.itrmPick = _data["itrmPick"];
            this.role = _data["role"];
            if (Array.isArray(_data["locationAdd"])) {
                this.locationAdd = [] as any;
                for (let item of _data["locationAdd"])
                    this.locationAdd.push(item);
            }
            if (Array.isArray(_data["locationDelete"])) {
                this.locationDelete = [] as any;
                for (let item of _data["locationDelete"])
...
export class ARIPMonitoring implements IARIPMonitoring {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.ipNo = _data["ipNo"];
            this.status = _data["status"];
            this.docTotal = _data["docTotal"];
            this.paidSum = _data["paidSum"];
...
export class ARIPDetails implements IARIPDetails {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.dscription = _data["dscription"];
...
export class IssueForProduction implements IIssueForProduction {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.itrNo = _data["itrNo"];
            this.branchName = _data["branchName"];
            this.docDate = _data["docDate"] ? new Date(_data["docDate"].toString()) : <any>undefined;
            this.status = _data["status"];
            this.daysDue = _data["daysDue"];
            this.reportCompletionNo = _data["reportCompletionNo"];
            this.docRemarks = _data["docRemarks"];
        }
    }
...
export class JobOrder implements IJobOrder {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.status = _data["status"];
            this.daysDue = _data["daysDue"];
            this.prodForecastNo = _data["prodForecastNo"];
            this.docRemarks = _data["docRemarks"];
        }
    }
...
export class JobOrderDetails implements IJobOrderDetails {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.description = _data["description"];
            this.quantity = _data["quantity"];
            this.priceAfVAT = _data["priceAfVAT"];
            this.lineTotal = _data["lineTotal"];
        }
    }
...
export class ProductionForecast implements IProductionForecast {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.docNum = _data["docNum"];
            this.daysDue = _data["daysDue"];
            this.goodsIssueNo = _data["goodsIssueNo"];
            this.grDocNum = _data["grDocNum"];
            this.status = _data["status"];
            this.docRemarks = _data["docRemarks"];
            this.docEntry = _data["docEntry"];
        }
...
export class SQGRDifference implements ISQGRDifference {
    ...
    init(_data?: any) {
        if (_data) {
            this.itemCode = _data["itemCode"];
            this.dscription = _data["dscription"];
            this.sqQuantity = _data["sqQuantity"];
            this.grQuantity = _data["grQuantity"];
        }
    }
...
export class PMRemarks implements IPMRemarks {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.logName = _data["logName"];
            this.remarks = _data["remarks"];
            this.sqNo = _data["sqNo"];
        }
    }
...
export class ProdOrderDetails implements IProdOrderDetails {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.description = _data["description"];
            this.quantity = _data["quantity"];
            this.itQuantity = _data["itQuantity"];
        }
    }
...
export class ITRITDifference implements IITRITDifference {
    ...
    init(_data?: any) {
        if (_data) {
            this.itemCode = _data["itemCode"];
            this.dscription = _data["dscription"];
            this.itrQuantity = _data["itrQuantity"];
            this.itQuantity = _data["itQuantity"];
        }
    }
...
export class ReportCompletion implements IReportCompletion {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.status = _data["status"];
            this.daysDue = _data["daysDue"];
            this.invTransferNo = _data["invTransferNo"];
            this.docRemarks = _data["docRemarks"];
        }
    }
